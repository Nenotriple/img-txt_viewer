...
class ImageTextViewer:
    def __init__(self, master):
        ...
        self.text_box = Text(master, height=30, width=100, wrap=WORD)
    ...
    def change_label(self):
        self.saved_label.config(text="Text Not Saved", fg="red")
    ...
    def save_text_file(self):
        if self.text_files:
            ...
            with open(text_file, "w") as f:
                f.write(self.text_box.get("1.0", END))
            self.saved_label.config(text="Text Saved", fg="green")
