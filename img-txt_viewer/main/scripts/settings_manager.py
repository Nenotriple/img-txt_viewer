...
#region Reset
    ...
    def reset_settings(self):
        ...
        # ONNX
        self.app.text_controller.auto_tag.auto_insert_mode_var.set(value="disable")
        self.app.text_controller.auto_tag.batch_interrogate_images_var.set(value=False)
        self.app.text_controller.auto_tag.autotag_gen_threshold_spinbox.set(value=0.35)
        self.app.text_controller.auto_tag.autotag_char_threshold_spinbox.set(value=0.8)
        self.app.text_controller.auto_tag.autotag_max_tags_spinbox.set(value=40)
        self.app.onnx_tagger.keep_underscore.set(value=False)
        self.app.onnx_tagger.keep_escape_character.set(value=True)
        self.app.text_controller.auto_tag.excluded_tags_entry.delete(0, 'end')
        self.app.text_controller.auto_tag.auto_exclude_tags_var.set(value=False)
        self.app.text_controller.auto_tag.keep_tags_entry.delete(0, 'end')
        self.app.text_controller.auto_tag.replace_tags_entry.delete(0, 'end')
        self.app.text_controller.auto_tag.replace_with_tags_entry.delete(0, 'end')
        # Other
