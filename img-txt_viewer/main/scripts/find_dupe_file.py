...
# --------------------------------------
    def setup_top_row(self):
        ...
        Tip.create(widget=self.help_button, text="Show/Hide Help", show_delay=50)
    ...
    def create_folder_selection(self):
        ...
        Tip.create(widget=self.open_button, text="Open path from folder entry.", padx=2)
...
# --------------------------------------
    def create_widgets(self):
        ...
        self.create_duplicate_handling_mode()
        self.create_run_stop_buttons()
        self.create_scan_mode_options()
        self.create_textlog()
        self.create_status_tray()
    ...
    def create_duplicate_handling_mode(self):
        ...
        Tip.create(widget=self.radio_single, text="Move extra duplicate files, leaving a copy behind.\nFiles will be stored in the '_Duplicate__Files' folder located in the parent folder.")
        ...
        Tip.create(widget=self.radio_both, text="Move all duplicate files, leaving no copy behind.\nFiles will be stored in the '_Duplicate__Files' folder located in the parent folder.\nDuplicates will be grouped into subfolders.")
        ...
        Tip.create(widget=self.undo_button, text="Restore all files to their original path.\nEnable 'Recursive' To also restore all files within subfolders.")
    ...
    def create_run_stop_buttons(self):
        ...
        Tip.create(widget=self.run_button, text="Process the selected folder.", show_delay=1000)
        ...
        Tip.create(widget=self.stop_button, text="Stop all running processes.")
        self.stop_button.pack(side="left")


    def create_scan_mode_options(self):
        ...
        Tip.create(widget=self.radio_images, text="Scan only image filetypes.")
        ...
        Tip.create(widget=self.radio_all_files, text="Scan all filetypes.")
        ...
        Tip.create(widget=self.move_captions_checkbutton, text="Move caption text files with images.")
    ...
    def create_status_tray(self):
        ...
        Tip.create(widget=self.tray_label_duplicates, text="Total number of duplicate files across all scanned folders.")
        ...
        Tip.create(widget=self.tray_label_total_files, text="Total number of files checked across all scanned folders.")
        ...
        Tip.create(widget=self.progress, text="Progressbar.")
