...
#region  Interface
    ...
    def create_options_frame(self):
        ...
        Tip.create(widget=self.use_output_folder_checkbutton, text="A new folder will be created in the selected directory called 'Resize Output' where images will be saved.", wraplength=200)
        # Overwrite files
        ...
        Tip.create(widget=self.overwrite_files_checkbutton, text="If enabled: Conflicting files will be overwritten.\nIf Disabled: Conflicting files will have '_#' appended to the filename.", wraplength=200)
        # Save Chunk Info
        ...
        Tip.create(widget=self.save_png_info_checkbutton, text="Auto-save PNG chunk info or create a text file on conversion.", wraplength=200)
        # Convert Only
        ...
        Tip.create(widget=self.convert_only_checkbutton, text="Ignore resize options and convert the images only.", wraplength=200)
