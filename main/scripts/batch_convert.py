...
#region -  Interface
    ...
    def setup_primary_frame(self):
        ...
        self.parent.batch_convert_tab.grid_rowconfigure(0, weight=1)
        self.parent.batch_convert_tab.grid_columnconfigure(0, weight=1)
        # Create and configure the main frame
        self.batch_convert_frame = tk.Frame(self.parent.batch_convert_tab)
        self.batch_convert_frame.grid(row=0, column=0, sticky="nsew")
        # Configure the main frame's grid
        self.batch_convert_frame.grid_rowconfigure(1, weight=1)
        self.batch_convert_frame.grid_columnconfigure(0, weight=1)


    def create_directory_row(self):
        self.top_frame = tk.Frame(self.batch_convert_frame)
    ...
    def create_control_row(self):
        self.frame_control_row = tk.Frame(self.batch_convert_frame, borderwidth=2)
        self.frame_control_row.pack(side="top", fill="x", padx=2, pady=2)


    def create_bottom_row(self):
        self.frame_bottom_row = tk.Frame(self.batch_convert_frame)
...
#region -  UI Functions
    ...
    def show_help(self):
        help_text = (
            ...
            "This tool allows you to convert multiple images at once.\n\n"
            "1. Select a directory containing images you wish to convert.\n"
            "2. Specify the format you want to convert to.\n"
            "3. Click the 'Convert Images' button to apply the changes.\n\n"
            "Options:\n"
            "- Choose the image format for conversion.\n"
        )
